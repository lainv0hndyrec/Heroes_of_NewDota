...
function lua_modifier_unfathomed_ethereal_order:AllowIllusionDuplicate() return true end
...
function lua_modifier_unfathomed_ethereal_order_status_color:AllowIllusionDuplicate() return true end
